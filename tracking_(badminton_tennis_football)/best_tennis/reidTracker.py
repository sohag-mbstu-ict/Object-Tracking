...
class ReidTracker:
    ...
    def remove_false_positive_detections_using_court_coordinates(self,results):
        ...
        court = Polygon([(442,153), (818,153), (1016,520), (280, 520)])
        bbox_=[]
        conf_=[]
        cls_=[]
...
v_path="/Byte/MyDrive/yolov8_bytetracker/input_video/tennis_4_6.mp4"

cap = cv2.VideoCapture(v_path)
total_frames = (cap.get(cv2.CAP_PROP_FRAME_COUNT))
print("total_frames : ",total_frames)
make_video = cv2.VideoWriter("badmen_2300.mp4", cv2.VideoWriter_fourcc(*'MP4V'), 20, (int(cap.get(3)), int(cap.get(4))))
...
model_path = "/Byte/MyDrive/yolov8_bytetracker/efficientnet_b1/tf_efficientnet_b1_ns-99dd0c41.pth"
